package com.example.demo.LayoutDemo1;
...
public class LayoutSampleApplication extends Stage {

    public LayoutSampleApplication() throws IOException {
    ...
    private HBox addHBox() {
        ...
        HBox hbox = new HBox();
        hbox.setPadding(new Insets(15, 12, 15, 12));//设置控件与 HBox 边缘之间的距离
        hbox.setSpacing(10);   // Gap between nodes,设置 spacing 属性来设置各个控件之间的距离
    ...
    private GridPane addGridPane() {
        ...
        //System.out.println(LayoutSampleApplication.class.getResourceAsStream("graphics/house.png"));
        ImageView imageHouse = new ImageView(
                new Image(LayoutSampleApplication.class.getResourceAsStream("graphics/house.png")));
        ...
        ImageView imageChart = new ImageView(
                new Image(LayoutSampleApplication.class.getResourceAsStream("graphics/piechart.png")));
    ...
    private FlowPane addFlowPane() {
        ...
        for (int i=0; i<8; i++) {
            pages[i] = new ImageView(
                    new Image(LayoutSampleApplication.class.getResourceAsStream(
